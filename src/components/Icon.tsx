...
export function Icon({ name, size = 24, ...props }: IconProps) {
  ...
  switch (name) {
    ...
    case 'settings':
      return (
        <svg {...common}>
          <path d="M12 2.75l1.05 1.9 2.16.45.45 2.16 1.9 1.05-.72 2.05 1.42 1.64-1.42 1.64.72 2.05-1.9 1.05-.45 2.16-2.16.45L12 21.25l-1.05-1.9-2.16-.45-.45-2.16-1.9-1.05.72-2.05L5.74 12l1.42-1.64-.72-2.05 1.9-1.05.45-2.16 2.16-.45L12 2.75Z" />
